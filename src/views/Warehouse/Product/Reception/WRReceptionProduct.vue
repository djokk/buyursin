<template>
  <div class="modelsItem">
    ...
    <div class="wrapper">
      <div v-if="infoItemsbybranch != []" class="card-custom">
        <div class="table-custom">
          ...
          <div class="table-custom__body">
            <div v-for="item in infoItemsbybranch" :key="item.id" class="table-custom__body-item">
    ...
    itemsbybranch() {
      ...
      axios.get(`${this.api}/itemsbybranch/?branchId=${this.auth.branchId}`, {
        ...
        .then(response => {
          ...
          this.infoItemsbybranch = response.data;
        })
