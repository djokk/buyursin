...
<div class="wrapper">
  <div class="header">
    <div class="header__sidebar-header sidebar-header" :class="[menuActive ? 'd-flex' : '']">
      <router-link :to="{name: 'Warehouse'}" class="sidebar-header__link-logo-title" href="">BUYURSIN</router-link>
      ...
      <nav class="nav">
        <ul class="nav__menu menu">
          <li class="menu__item" @click.prevent="isSidebarActiveItem(1)" :class="[isActiveItem == 1 ? 'active': '']">
            <router-link :to="{name: 'WRStore'}" class="menu__link" href=""><i class='bx bxs-home'></i>{{ $t('store') }}</router-link>
          </li>
