...
<div class="wrapper">
  <div class="header">
    <div class="header__sidebar-header sidebar-header" :class="[menuActive ? 'd-flex' : '']">
      <router-link :to="{name: 'Dashboard'}" class="sidebar-header__link-logo-title" href="">BUYURSIN</router-link>
      ...
      <nav class="nav">
        <ul class="nav__menu menu">
          <li class="menu__item" @click.prevent="isSidebarActiveItem(1)" :class="[isActiveItem == 1 ? 'active': '']">
            <router-link :to="{name: 'Dashboard'}" class="menu__link" href=""><i class='bx bxs-home'></i>{{ $t('dashboard') }}</router-link>
          </li>
          ...
          <li class="menu__item" @click.prevent="isSidebarActiveItem(3)" :class="[isActiveItem == 3 ? 'active': '']">
            <router-link :to="{ name: 'Models'}" class="menu__link"><i class='bx bxs-t-shirt'></i>{{ $t('model') }}</router-link>
          </li>
          <li class="menu__item" @click.prevent="isSidebarActiveItem(6)" :class="[isActiveItem == 6 ? 'active': '']">
            <router-link :to="{ name: 'Store'}" class="menu__link"><i class='bx bxs-cylinder'></i>{{ $t('Склад') }}</router-link>
          </li>
          <li class="menu__item" @click.prevent="isSidebarActiveItem(4)" :class="[isActiveItem == 4 ? 'active': '']">
            <router-link :to="{ name: 'Product', query: { name: 'Sending'} }" class="menu__link"><i class='bx bx-upload'></i>{{ $t('Отправка') }}</router-link>
          </li>
          <li class="menu__item" @click.prevent="isSidebarActiveItem(5)" :class="[isActiveItem == 5 ? 'active': '']">
            <router-link :to="{ name: 'Product', query: { name: 'Reception'} }" class="menu__link"><i class='bx bx-window-open'></i>{{ $t('Прием') }}</router-link>
          </li>
          <li class="menu__item">
  ...
  <div v-show="bgLogout" @click="removeLogout()" class="logout-bg"></div>
</div>
</template>
